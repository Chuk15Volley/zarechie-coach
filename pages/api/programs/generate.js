...
const FOCUS_LABELS = {
  ...
  camp_iso_anterior:  'СБОРЫ · ИЗОМЕТРИКА · Передняя цепь — ПН+ПТ нед.4-5; пауза в напряжении 5 сек в угле 60-90° колено → вверх максимально резко; вечером ВОЛЕЙБОЛ С ПРЫЖКАМИ — проверяй JLU из дашборда, если >200 прыжков — плиометрику Блока A снизить 50%',
  camp_iso_posterior: 'СБОРЫ · ИЗОМЕТРИКА · Задняя цепь — ВТ+СБ нед.4-5; пауза в напряжении 5 сек в угле 45° бедро → вверх максимально резко; вечером ВОЛЕЙБОЛ С ПРЫЖКАМИ — проверяй JLU из дашборда',
...
const NK_MANUAL_FOCUS_LABELS = {
  ...
  camp_iso_anterior:  'СБОРЫ · ИЗОМЕТРИКА · Передняя цепь — ручной выбор тренера; пауза в напряжении 5 сек в угле 60-90° колено → вверх максимально резко; без календарной привязки',
