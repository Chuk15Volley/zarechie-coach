...
export function playerPhotoKey(workspace, playerId) {
  return `${pfx(workspace)}:player:photo:${playerId}`;
}
...
export function developmentPlanKey(workspace, playerId) {
  return `${pfx(workspace)}:development_plan:${playerId}`;
}

export function returnToPlayKey(workspace, playerId) {
  return `${pfx(workspace)}:return_to_play:${playerId}`;
}

export function adaptationDraftKey(workspace, playerId, date) {
  return `${pfx(workspace)}:adaptation:draft:${playerId}:${date}`;
}

export function adaptationOutcomeKey(workspace, playerId) {
  return `${pfx(workspace)}:adaptation:outcome:${playerId}`;
}

export function adaptationHistoryKey(workspace, playerId) {
  return `${pfx(workspace)}:adaptation:history:${playerId}`;
}

export function adaptationBatchDraftKey(workspace, batchId) {
  return `${pfx(workspace)}:adaptation:batch:draft:${batchId}`;
}

export function adaptationBatchAppliedKey(workspace, batchId) {
  return `${pfx(workspace)}:adaptation:batch:applied:${batchId}`;
}

export function adaptationBatchLatestKey(workspace) {
  return `${pfx(workspace)}:adaptation:batch:latest`;
}

export function liveCommandsKey(workspace, playerId, date) {
  return `${pfx(workspace)}:live_commands:${playerId}:${date}`;
}

export function operationsSnapshotKey(workspace, id) {
  return `${pfx(workspace)}:ops_snapshot:${id}`;
}
