...
export function restrictedDayPlan({ snapshot, recommendation, date, dayGoal = '', playerRestrictions = [] }) {
  const draft = restrictedUpperDraft({ snapshot, recommendation, date, dayGoal, playerRestrictions });
