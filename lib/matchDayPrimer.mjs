...
export function formatMatchDayPrimerForPrompt(context) {
  ...
  return `\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
    ...
    `• Силовые/тяговые движения: 1–3 повтора; двусторонние прыжки/броски: 2–4 повтора. Односторонние прыжки (включая Lateral Bound) — только 1–2 на каждую сторону за подход; запись N/side считается как 2×N контактов. В полном режиме суммарно не более 8 прыжковых контактов. Никогда не назначай 3–4/side. В полном режиме 2 круга; в reduced 1–2; в minimal/modified не более 1.\n` +
    `• targetSets никогда не может быть пустым. Full: ровно 2 элемента у каждого упражнения; reduced: 1–2 с суммой 8–10 подходов; minimal/modified: ровно 1 элемент у каждого из 6 упражнений.\n` +
    ...
    `• В minimal/modified и при stale-данных alternatives у всех упражнений — пустой массив: не предлагай динамическую силовую замену. В остальных режимах альтернатива обязана сохранять ту же роль и группу библиотеки.\n` +
